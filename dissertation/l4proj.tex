...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{images/examples/example_3/switch}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{images/examples/example_1/example1_diagram.pdf}
    ~
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,angle=270]{images/examples/example_4/example4_diagram.pdf}
    ~
