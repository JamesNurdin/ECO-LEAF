...
def main():
    """
DEBUG	117: application_meter: PowerMeasurement(dynamic=0.47W, static=20.50W)
DEBUG	117: infrastructure_meter: PowerMeasurement(dynamic=0.45W, static=20.50W)
...
INFO	Total carbon emitted: 8.910269082222213 gCo2
    """
    ...
    fig1 = file_handler.subplot_time_series_entities(power_domain, "Power Used", entities=entities)
    fig2 = file_handler.subplot_time_series_power_sources(power_domain, "Power Available", power_sources=[grid])
    fig3 = file_handler.subplot_time_series_power_meter(power_domain, power_meters=[application_pm, infrastructure_pm])
    figs = [fig1, fig2, fig3]
