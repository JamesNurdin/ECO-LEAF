...
def main():
    ...
    power_domain = PowerDomain(env, name="Power Domain 1", associated_nodes=[node], smart_node_distribution=True,
                               start_time_str="19:00:00", update_interval=1)  # Creating Power domain to run at 7pm
